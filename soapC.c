...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.21 2016-01-26 02:36:20 GMT")
...
{	int *p;
	p = soap_inint(soap, tag, a, type, SOAP_TYPE_xsd__float);
	return p;
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_xsd__float(struct soap *soap, const int *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_xsd__float);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_xsd__int);
...
SOAP_FMAC3 struct ns__verifyImg * SOAP_FMAC4 soap_in_ns__verifyImg(struct soap *soap, const char *tag, struct ns__verifyImg *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__verifyImg *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__verifyImg, sizeof(struct ns__verifyImg), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__verifyImg *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__verifyImg, 0, sizeof(struct ns__verifyImg), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__verifyImg);
	if (soap_out_ns__verifyImg(soap, tag?tag:"ns:verifyImg", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct ns__verifyImgResponse * SOAP_FMAC4 soap_in_ns__verifyImgResponse(struct soap *soap, const char *tag, struct ns__verifyImgResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__verifyImgResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__verifyImgResponse, sizeof(struct ns__verifyImgResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__verifyImgResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__verifyImgResponse, 0, sizeof(struct ns__verifyImgResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__verifyImgResponse);
	if (soap_out_ns__verifyImgResponse(soap, tag?tag:"ns:verifyImgResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__ping(struct soap *soap, const struct ns__ping *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_xsd__string(soap, &a->stringHello);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__ping(struct soap *soap, const char *tag, int id, const struct ns__ping *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__ping), type))
		return soap->error;
	if (soap_out_xsd__string(soap, "stringHello", -1, &a->stringHello, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_stringHello && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_xsd__string(soap, "stringHello", &a->stringHello, "xsd:string"))
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__ping);
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_ns__pingResponse);
...
{
	register int id = soap_embed(soap, (void*)a, (struct soap_array*)(void*)&a->__ptr, 1, SOAP_TYPE_xsd__base64Binary);
	if (soap_out_xsd__base64Binary(soap, tag?tag:"SOAP-ENC:Array", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerToxsd__string);
